...
client.on('guildCreate', guild => {
	...
	client.user.setGame(prefix + 'ak!yardım | ' + client.guilds.size + ' sunucu | ' + client.guilds.reduce((a, b) => a + b.memberCount, 0).toLocaleString() + ' kullanıcı');
})
